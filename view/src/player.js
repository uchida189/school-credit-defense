import { Sprite, imageAssets } from '../../node_modules/kontra/kontra.mjs';
...
export class Player {
    constructor(playerType, bullet, canvas) {
        ...
        this.sprite = Sprite({
          ...
          image: imageAssets[`assets/player${playerType}.png`], // プレイヤーの画像を取得
        ...
        this.sprite.image.width = playerWidth;  // プレイヤーの幅
        this.sprite.image.height = playerHeight; // プレイヤーの高さ
